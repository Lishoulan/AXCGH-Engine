#!/usr/bin/env python3
"""
train_512.py — Train a DeepCGH model at 512x512 resolution and export to ONNX.

Configuration:
  - Resolution: 512x512, 5 depth planes
  - int_factor: 2 (compatible with current engine)
  - n_kernels: [32, 64, 128] (larger model for higher resolution)
  - Training: 50 epochs, batch_size=2, lr=1e-4
...
ONNX_PATH = os.path.join('DeepCGHEngine', 'models', 'deepcgh_unet_512.onnx')
...
# Step 1: Dataset
# ---------------------------------------------------------------------------
print("[1/4] Preparing mixed dataset (512x512, 5 planes, 2000 samples)...")

from deepcgh import DeepCGH, DeepCGH_Datasets

data_params = {
    'shape': (H, W, C),
    'data_path': 'dd/Train_512',
    'N': N_SAMPLES,
    'train_ratio': 0.9,
    'object_type': 'Mixed',
    'object_size': [3, 8],
...
print(f"\n[DONE] 512x512 training and ONNX export complete!")
